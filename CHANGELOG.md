...
- implement async generators and streaming for log extraction (`pipeline`) (`64fac9c56f1117b0e5326691585d0880566a16ea`)
  > Rediseñar getCommits, runPipeline y runGenerate para consumir logs de forma asíncrona mediante iteradores, reduciendo drásticamente el consumo de Heap en repositorios grandes.

## Documentación
- auto-generate latest changelog and pap using tu-doc-cli (`8605a8dae1fe2627209222f833887415a71a3420`)
- add strict conventional commits warning and expand wizard details (`readme`) (`edad9189d830dd0f630750a4312ccb939556d7e7`)
- rewrite as robust user guide and document npx usage (`readme`) (`0206f9389b4f4b325d5e0c6ca66b3c09c79013bd`)
...
## Compilación
- link github repository (`pkg`) (`f74cb12f65be6669383cdd4182aaa94691a78b96`)
- prepare for npx publication by updating name and files (`pkg`) (`35102897fb78cb298cf11a42452a487a483e4327`)
